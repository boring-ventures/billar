...
export default function About() {
  ...
  return (
    <section id="about" className="py-24 bg-gradient-to-br from-secondary/10 via-primary/15 to-primary/20 relative overflow-hidden">
      ...
      />
      <div className="absolute top-10 left-0 w-96 h-96 bg-primary/15 rounded-full blur-3xl -z-10 opacity-80" />
      <div className="absolute bottom-20 right-0 w-96 h-96 bg-secondary/20 rounded-full blur-3xl -z-10 opacity-70" />
      {/* Subtle wooden tone accent */}
      <div className="absolute right-[10%] top-[30%] w-64 h-64 bg-[#A1887F]/10 rounded-full blur-3xl -z-10" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <MotionSection type="slide" duration={0.6}>
              <div>
                <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                  The Smarter Way to <span className="text-primary">Manage Your Billar Hall</span>
                </h2>
          ...
          <div className="relative">
            ...
            <MotionSection delay={0.3} type="scale" duration={0.7}>
              <div className="relative rounded-2xl overflow-hidden shadow-xl border-8 border-white bg-white/90">
              ...
              <motion.div 
                className="absolute -bottom-8 -right-8 bg-white rounded-xl p-6 shadow-xl border border-primary/10 max-w-xs"
