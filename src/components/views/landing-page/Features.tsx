        ...
        <MotionSection type="slide" duration={0.7}>
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Everything You Need to Run Your Billar Hall
            </h2>
            <p className="text-xl text-gray-600">
              Our comprehensive suite of tools helps you streamline operations,
              increase revenue, and enhance player satisfaction.
            </p>
          </div>
        </MotionSection>
          ...
          <div className="mt-16 bg-white border border-gray-100 rounded-2xl p-8 md:p-10 shadow-sm max-w-5xl mx-auto">
            <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
              ...
              >
                <motion.a 
                  href="#" 
                  className="inline-flex items-center justify-center rounded-md text-sm font-medium bg-primary text-white h-10 px-4 py-2 hover:bg-primary/90 transition-colors"
                  whileHover={{ y: -2 }}
                  whileTap={{ y: 1 }}
                >
                  Watch Demo
